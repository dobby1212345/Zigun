...
export default async function LongStoriesPage({ searchParams }: Props) {
      ...
      <div className="p-8">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-foreground">장편</h1>
              <p className="text-muted-foreground mt-2">긴 호흡의 이야기</p>
            </div>
